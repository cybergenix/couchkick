...
class OpportunitiesControllerTest < ActionController::TestCase
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post :create, opportunity: { entrepreneur_id: @opportunity.entrepreneur_id, opportunity_type: @opportunity.opportunity_type, usertype: @opportunity.usertype }
    end
  ...
  test "should update opportunity" do
    put :update, id: @opportunity, opportunity: { entrepreneur_id: @opportunity.entrepreneur_id, opportunity_type: @opportunity.opportunity_type, usertype: @opportunity.usertype }
    assert_redirected_to opportunity_path(assigns(:opportunity))
  end
