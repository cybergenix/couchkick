...
class ProposalsControllerTest < ActionController::TestCase
  ...
  test "should create proposal" do
    assert_difference('Proposal.count') do
      post :create, proposal: { findentrepreneur_id: @proposal.findentrepreneur_id, message: @proposal.message }
    end
  ...
  test "should update proposal" do
    put :update, id: @proposal, proposal: { findentrepreneur_id: @proposal.findentrepreneur_id, message: @proposal.message }
    assert_redirected_to proposal_path(assigns(:proposal))
  end
